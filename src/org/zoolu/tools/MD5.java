...
public class MD5 extends MessageDigest {
	...
	private static void transform(int[] state, byte[] block) {
		...
		int[] x = new int[16];
		x[0] = (block[0] & 0xff) | ((block[1] & 0xff) << 8)
				| ((block[2] & 0xff) << 16)
				| ((block[3]) << 24);
		x[1] = (block[4] & 0xff) | ((block[5] & 0xff) << 8)
				| ((block[6] & 0xff) << 16)
				| ((block[7]) << 24);
		x[2] = (block[8] & 0xff) | ((block[9] & 0xff) << 8)
				| ((block[10] & 0xff) << 16)
				| ((block[11]) << 24);
		x[3] = (block[12] & 0xff) | ((block[13] & 0xff) << 8)
				| ((block[14] & 0xff) << 16)
				| ((block[15]) << 24);
		x[4] = (block[16] & 0xff) | ((block[17] & 0xff) << 8)
				| ((block[18] & 0xff) << 16)
				| ((block[19]) << 24);
		x[5] = (block[20] & 0xff) | ((block[21] & 0xff) << 8)
				| ((block[22] & 0xff) << 16)
				| ((block[23]) << 24);
		x[6] = (block[24] & 0xff) | ((block[25] & 0xff) << 8)
				| ((block[26] & 0xff) << 16)
				| ((block[27]) << 24);
		x[7] = (block[28] & 0xff) | ((block[29] & 0xff) << 8)
				| ((block[30] & 0xff) << 16)
				| ((block[31]) << 24);
		x[8] = (block[32] & 0xff) | ((block[33] & 0xff) << 8)
				| ((block[34] & 0xff) << 16)
				| ((block[35]) << 24);
		x[9] = (block[36] & 0xff) | ((block[37] & 0xff) << 8)
				| ((block[38] & 0xff) << 16)
				| ((block[39]) << 24);
		x[10] = (block[40] & 0xff) | ((block[41] & 0xff) << 8)
				| ((block[42] & 0xff) << 16)
				| ((block[43]) << 24);
		x[11] = (block[44] & 0xff) | ((block[45] & 0xff) << 8)
				| ((block[46] & 0xff) << 16)
				| ((block[47]) << 24);
		x[12] = (block[48] & 0xff) | ((block[49] & 0xff) << 8)
				| ((block[50] & 0xff) << 16)
				| ((block[51]) << 24);
		x[13] = (block[52] & 0xff) | ((block[53] & 0xff) << 8)
				| ((block[54] & 0xff) << 16)
				| ((block[55]) << 24);
		x[14] = (block[56] & 0xff) | ((block[57] & 0xff) << 8)
				| ((block[58] & 0xff) << 16)
				| ((block[59]) << 24);
		x[15] = (block[60] & 0xff) | ((block[61] & 0xff) << 8)
				| ((block[62] & 0xff) << 16)
				| ((block[63]) << 24);
