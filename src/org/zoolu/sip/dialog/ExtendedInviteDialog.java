...
public class ExtendedInviteDialog extends org.zoolu.sip.dialog.InviteDialog {
	...
	{
		Message req = BaseMessageFactory.createRequest(this, BaseSipMethods.INFO, null);
	...
	public void respond(Message resp) {
		...
		if (method.equals(BaseSipMethods.INVITE)
				|| method.equals(BaseSipMethods.CANCEL)
				|| method.equals(BaseSipMethods.BYE)) {
			super.respond(resp);
		} else {
	...
	public void acceptRefer(Message req) {
		...
		Message resp = BaseMessageFactory.createResponse(req, 202, SipResponses
				.reasonOf(200), null);
		respond(resp);
	}
	...
	public void refuseRefer(Message req) {
		...
		Message resp = BaseMessageFactory.createResponse(req, 603, SipResponses
				.reasonOf(603), null);
		respond(resp);
	}
	...
	public void onReceivedMessage(SipProvider provider, Message msg) {
		...
		if (msg.isResponse()) {
			...
			if (msg.isRefer()) { // Message
				...
				Message resp = BaseMessageFactory.createResponse(msg, 200,
