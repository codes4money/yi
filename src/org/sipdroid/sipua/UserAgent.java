...
//	private void addMediaDescriptor(String media, int port, Codecs.Map c,int rate) {
	...
	public boolean accept() 
	{
		...
		android.util.Log.d("call","accept");
		printLog("ACCEPT");
		changeStatus(UA_STATE_INCALL); // modified
		call.accept(local_session);
		
		android.util.Log.d("����=====3","33333333333333333333333333");
	...
	private void sessionProduct(SessionDescriptor remote_sdp) {
		...
		android.util.Log.d("local_sdpnew",local_sdp.toString());
		android.util.Log.d("remote_sdpnew",remote_sdp.toString());
		...
		new_sdp = SdpTools.sdpMediaProduct(new_sdp, remote_sdp
			...
			android.util.Log.d("local_sdpnew2",new_sdp.toString());
		...
		android.util.Log.d("local_sdpnew3",new_sdp.toString());
	...
	public void onCallIncoming(Call call, NameAddress callee,
		...
		android.util.Log.d("call","onCallIncoming");
		if (call != this.call) {
	...
	public void onCallRinging(Call call, Message resp) {
		...
		android.util.Log.d("call","onCallRinging");
		...
		if (remote_sdp==null || remote_sdp.length()==0) {
			...
			if (!user_profile.no_offer) { 
				...
				android.util.Log.d("����=====1","11111111111111111");
				launchMediaApplication();
			}
		}
	}
	...
	{
		android.util.Log.d("call","onCallAccepted");
		...
		android.util.Log.d("����=====2","2222222222222222222222");
		launchMediaApplication();
