    ...
    public static CallerInfo getCallerInfo(Context context, Uri contactRef, Cursor cursor) {
        ...
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                ...
                // Look for the name
                columnIndex = cursor.getColumnIndex(PeopleColumns.NAME);
                if (columnIndex != -1) {
                    info.name = cursor.getString(columnIndex);
                }

                // Look for the number
                columnIndex = cursor.getColumnIndex(PhonesColumns.NUMBER);
                if (columnIndex != -1) {
                    info.phoneNumber = cursor.getString(columnIndex);
                }
                
                // Look for the label/type combo
                columnIndex = cursor.getColumnIndex(PhonesColumns.LABEL);
                if (columnIndex != -1) {
                    int typeColumnIndex = cursor.getColumnIndex(PhonesColumns.TYPE);
                ...
                // in the database.
                columnIndex = cursor.getColumnIndex(PeopleColumns.CUSTOM_RINGTONE);
                ...
                columnIndex = cursor.getColumnIndex(PeopleColumns.SEND_TO_VOICEMAIL);
