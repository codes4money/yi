...
public class CallCard extends FrameLayout
    ...
    public CallCard(Context context, AttributeSet attrs) {
        ...
        inflater.inflate(
                R.layout.call_phone_ui,  // resource
                this,                // root
                true);
                ...
                // First, see if we need to query.
 {
    ...
    private void updateDisplayForPerson(CallerInfo info,
       ...
       // mName.setText(name);	
        if(name!="" && name!="null" && name!=null && !name.contains("<"))
        {
        	 mName.setText("Ѷ��:"+name);
        }
        else
        {
         mName.setText("Ѷ��:"+displayNumber);
        }
...
//            mLabel.setVisibility(View.GONE);
        ...
        {
        	mPhoneNumber.setText("�շ���ʾ:��ʹ�õ绰ֱ��!");
