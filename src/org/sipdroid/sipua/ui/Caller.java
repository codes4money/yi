					...
					{					
				    	...
				    	for(int i = 0; i < vExPats.size(); i++)
			            {
				    		if (vExPats.get(i).startsWith("h") || vExPats.get(i).startsWith("H"))
			        			vTypesCode.add(Integer.valueOf(PhonesColumns.TYPE_HOME));
				    		else if (vExPats.get(i).startsWith("m") || vExPats.get(i).startsWith("M"))
			        			vTypesCode.add(Integer.valueOf(PhonesColumns.TYPE_MOBILE));
				    		else if (vExPats.get(i).startsWith("w") || vExPats.get(i).startsWith("W"))
			        			vTypesCode.add(Integer.valueOf(PhonesColumns.TYPE_WORK));
				    		else 
	        			        ...
	        			        {	        			        	
	        			            ...
	        			            while (phonesCursor.moveToNext()) 
	        			            {
	        			                ...
	        			                String n = phonesCursor.getString(0);
	         			                ...
	         			                if (type == PhonesColumns.TYPE_MOBILE || type == PhonesColumns.TYPE_HOME || type == PhonesColumns.TYPE_WORK) 
	         			                {
