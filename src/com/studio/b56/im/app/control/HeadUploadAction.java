...
import com.studio.b56.im.app.ui.common.BitmapUtils;
...
public class HeadUploadAction implements OnBitmapListener{
	...
	public void uploadHead(Bitmap bm) {
		...
		albumApi.upload(application.getUserInfoVo().getUid(),Constants.PhotoType.PHOTO_HEAD, bm, CompressFormat.PNG, new ClientAjaxCallback() {
	...
	private void uploadsuccess(String t) {
		...
		if(data != null){
			...
			// 修改个人信息.
			userInfoApi.editInfo(application.getUserInfoVo().getUid(), params, new ClientAjaxCallback() {
