...
public class AuthorizeActivity extends BaseActivity implements IXListViewListener{
	...
	private void pullAuthList(){
		...
		mUserInfoApi.authUser(getUserInfoVo().getUid(), (currPage) + "", pageSize + "", new ClientAjaxCallback() {
	...
	private void delAuthUser(final CustomerVo customerVo){
		...
		mUserInfoApi.delAuthUser(getUserInfoVo().getUid(), customerVo.getUid(), new ClientAjaxCallback() {
