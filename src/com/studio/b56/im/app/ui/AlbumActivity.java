...
import com.studio.b56.im.adapter.AlbumAdapter;
import com.studio.b56.im.app.AlbumPromptDialog;
...
//					finish();
	...
	public void DeleteAlbum() {
		...
		albumApi.delAlbum(uid, albumVo.getAid(), new ClientAjaxCallback() {
			@Override
			public void onStart() {
				// TODO 开始删除
				super.onStart();
	...
	private void getNetworkAlbum(final boolean isFlag) {
		// TODO 从服务器获取相册信息
			...
			AlbumApi albumApi = new AlbumApi();
			String uid = userInfoVo.getUid();
			albumApi.getAlbum(uid, uid, new ClientAjaxCallback() {
				@Override
				public void onStart() {
					// TODO 准备从服务器获取
					super.onStart();
