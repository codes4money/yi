...
public abstract class ChattingDetailActivity extends DetailActivity{
	...
	protected void baseInit(){
		...
		txtSscoreTag.setVisibility(View.GONE);
		txtAscoreTag.setVisibility(View.GONE);
		txtAscoreNum.setVisibility(View.GONE);
		txtSscoreNum.setVisibility(View.GONE);
		ratingAscore.setVisibility(View.GONE);
		ratingSscore.setVisibility(View.GONE);
		scoreNum.setVisibility(View.GONE);
