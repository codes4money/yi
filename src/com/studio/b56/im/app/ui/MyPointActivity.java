...
import com.studio.b56.im.app.PointPromptDialog;
...
public class MyPointActivity extends BaseActivity {
	...
	protected void baseInit() {
		super.baseInit();
		new SundryApi().getTips(SundryApi.TIPS_ACREDIT, new ClientAjaxCallback() {
	...
	private void getPointInfo() {
		...
		if (checkNetWork()) {
			...
			creditApi.getCredit(uid, new ClientAjaxCallback() {
