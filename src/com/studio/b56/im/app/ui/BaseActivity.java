...
public abstract class BaseActivity extends FinalActivity{
	...
	class AddFriendCallback extends ClientAjaxCallback{
		@Override
		public void onStart() {
			super.onStart();
	 ...
	 * @since
	 */
	class ApplyAuthCallback extends ClientAjaxCallback{
		@Override
		public void onStart() {
			super.onStart();
			getWaitDialog().setMessage("提交请求");
		...
		public void onSuccess(String t) {
			...
			try {
				...
				{       List<GroupVo> cVos=new LinkedList<GroupVo>();
						...
						FinalDb db = FinalFactory.createFinalDb(BaseActivity.this,getUserInfoVo());
