...
//		getBtnApply2().setOnClickListener(l);
	...
	protected void showHeadInfo() {
		...
		int ageint=TextdescTool.dateToAge(customer.getBirthday());
		if(ageint>0)
		{
			this.txtAge.setText(ageint+"岁");
		}
		else
		{
			this.txtAge.setText("");
...
//		mApply.setVisibility(View.VISIBLE);
	...
	protected void getNetworkAlbum() {
		...
		if (!checkNetWork()) {
			...
			albumApi.getAlbum(uid, getCustomer().getUid(), new ClientAjaxCallback() {
				@Override
				public void onStart() {
					// TODO 准备从服务器获取
					super.onStart();
...
//
//		getCustomer().getUid(), new ClientAjaxCallback() {
//
//			@Override
//			public void onSuccess(String t) {
//				super.onSuccess(t);
...
//	}
	...
	public void editSorce(String asorce, String ssorce) {
		userInfoApi.editScore(getUserInfoVo().getUid(), getCustomer().getUid(),
				asorce, ssorce, new ClientAjaxCallback() {
					@Override
					public void onStart() {
						// TODO Auto-generated method stub
						super.onStart();
...
//			return;
//		}
//		getUserInfoApi().checkAuth(getUserInfoVo().getUid(), customer.getUid(), new ClientAjaxCallback() {
//
//			@Override
//			public void onSuccess(String t) {
//				super.onSuccess(t);
...
//	}
	...
	protected void getRefresh() {
		...
		getUserInfoApi().getInfo(getMyCustomerVo().getUid(), customer.getUid(), new ClientAjaxCallback() {
