...
public class HeadAuthActivity extends BaseActivity{
	...
	private void uploadHead(Bitmap bm) {
		...
		albumApi.upload(userInfoVo.getUid(),Constants.PhotoType.PHOTO_HEAD, bm, new ClientAjaxCallback() {
	...
	private void uploadsuccess(String t) {
		try {
			...
			if(data != null){
				...
				new AlbumApi().addAuthPhoto(userInfoVo.getUid(), data, new ClientAjaxCallback() {
