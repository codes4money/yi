...
//		broadcast = new MyBroadcast();
		...
		setTitleContent(fCustomerVo.getName());
		initMessageInfos();
		...
		public void onClick(View v) {
			...
			if(customerVo != null){
				...
				if(getUserInfoVo().getUid().equals(customerVo.getUid())){
					...
					intent = new Intent(ChatMainActivity.this, ChatDetailActivity.class);
					intent.putExtra("sessionList", sessionList);
					//intent.putExtra("messageInfos", messageInfos);
	...
	class MyAdapter extends BaseAdapter{
		...
		private void bindView(ViewHolder viewHolder, MessageInfo messageInfo){
			...
			case MessageType.TEXT:
				...
				String str11=messageInfo.getContent();
				if(str11.length()<=10)
				{
					str11=" "+str11;
				}
				viewHolder.txtMsg.setText(EmojiUtil.getExpressionString(getBaseContext(), str11, EMOJIREX));
				break;
			case MessageType.PICTURE:
				viewHolder.txtMsgMap.setVisibility(View.GONE);
				String content = messageInfo.getContent();
