...
import com.studio.b56.im.app.api.KitingRecordApi;
import com.studio.b56.im.app.api.PanLvApi.ClientAjaxCallback;
import com.studio.b56.im.app.ui.common.RecordEcode;
...
public class KitingActivity extends BaseActivity implements IXListViewListener{
	...
	private void getRecord(){
		mKitingRecordApi.getCreditRecord(getUserInfoVo().getUid(), currPage + "", pageSize + "", new ClientAjaxCallback() {
