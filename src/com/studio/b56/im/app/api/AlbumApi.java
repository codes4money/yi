...
public class AlbumApi extends PanLvApi {
	...
	public void addAlbum(String uid, String albumName, String albumCover,
			String privacy, ClientAjaxCallback callBack) {
		attribleEmpty(uid);
	 ...
	 *            修改时间:<br />
	 */
	public void getAlbum(String uid, String touid, ClientAjaxCallback callBack) {
		attribleEmpty(uid);
		attribleEmpty(touid);
	...
	public void editAlbum(String uid, String aid, String albumName,
			String ablumCover, String privacy, ClientAjaxCallback callBack) {
		attribleEmpty(uid);
	 ...
	 *            修改时间:<br />
	 */
	public void delAlbum(String uid, String aid, ClientAjaxCallback callBack) {
		attribleEmpty(aid);
	...
	public void upload(String uid, String type, File fileName,
			ClientAjaxCallback callBack) throws FileNotFoundException {
		attribleEmpty(type);
	...
	public void upload(String uid, String type, Bitmap bitmap,
			CompressFormat format, ClientAjaxCallback callBack) {
		attribleEmpty(type);
	 ...
	 *            修改时间:<br />
	 */
	public void delPhoto(String uid, String pid, ClientAjaxCallback callBack) {
		attribleEmpty(uid);
		attribleEmpty(pid);
	...
	public void editPhoto(String uid, String pid, String photoName,
			String prvivacy, String auth, ClientAjaxCallback callBack) {
		attribleEmpty(uid);
		attribleEmpty(pid);
