...
import com.studio.b56.im.app.vo.AccountVo;
...
public class UserInfoApi extends PanLvApi{
	 ...
	 * 修改时间:<br />
	 */
	public void editInfo(String uid, Map<String, String> infos, ClientAjaxCallback callBack){
		attribleEmpty(uid);
		attribleEmpty(infos);
	 ...
	 * 修改时间:<br />
	 */
	public void getInfo(String uid, String toUid, ClientAjaxCallback callBack){
		attribleEmpty(uid);
		attribleEmpty(toUid);
	 ...
	 * 修改时间:<br />
	 */
	public void addInfo(String uid, Map<String, String> maps, ClientAjaxCallback callBack){
		attribleEmpty(uid);
		attribleEmpty(maps);
	 ...
	 * 修改时间:<br />
	 */
	public void getScore(String uid, String toUid, ClientAjaxCallback callBack){
		attribleEmpty(uid);
//		attribleEmpty(toUid);
	 ...
	 * 修改时间:<br />
	 */
	public void editScore(String uid, String toUid, String asorce, String ssorce, ClientAjaxCallback callBack){
		attribleEmpty(uid);
		attribleEmpty(toUid);
	 ...
	 * 修改时间:<br />
	 */
	public void applyAuth(String uid, String toUid, ClientAjaxCallback callBack){
	...
	public void getScoreList(String uid, String toUid, String page, String pageSize, ClientAjaxCallback callBack){
	...
	public void agAuth(String uid, String toUid, ClientAjaxCallback callBack){
	...
	public void authUser(String uid, String page, String pageSize, ClientAjaxCallback callBack){
	...
	public void delAuthUser(String uid, String toUid, ClientAjaxCallback callBack){
	...
	public void refApp(String uid, String toUid, ClientAjaxCallback callBack){
	...
	public void checkAuth(String uid, String toUid, ClientAjaxCallback callBack){
	 ...
	 * 申请提现
	 * */
	public void account(String uid, AccountVo accountVo, ClientAjaxCallback callBack)
	{
	 ...
	 * 获取提现的信息
	 * */
	public void getAccount(String uid, ClientAjaxCallback callBack)
	{
