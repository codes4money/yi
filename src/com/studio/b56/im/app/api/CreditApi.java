...
public class CreditApi extends PanLvApi {
	 ...
	 * 获取积分信息
	 * */
	public void getCredit(String uid, ClientAjaxCallback callBack) {
	 ...
	 * 修改时间:<br />
	 */
	public void getBuyConfig(String uid, ClientAjaxCallback callBack){
	 ...
	 * 修改时间:<br />
	 */
	public void buyVip(String uid, String credit, String value, ClientAjaxCallback callBack){
