...
public class FriendApi extends PanLvApi{
	 ...
	 * 修改时间:<br />
	 */
	public void getFriendList(String uid, ClientAjaxCallback callBack){
	 ...
	 * 修改时间:<br />
	 */
	public void delFriend(String uid, String fuid, ClientAjaxCallback callBack){
		attribleEmpty(fuid);
	 ...
	 * 修改时间:<br />
	 */
	public void beFriend(String uid, String fuid, ClientAjaxCallback callBack){
		attribleEmpty(fuid);
	 ...
	 * 修改时间:<br />
	 */
	public void refuseFriend(String uid, String fuid, ClientAjaxCallback callBack){
	 ...
	 * 修改时间:<br />
	 */
	public void toFriend(String uid, String fuid, ClientAjaxCallback callBack){
		attribleEmpty(fuid);
	 ...
	 * 修改时间:<br />
	 */
	public void markFriend(String uid, String fuid, String markName, ClientAjaxCallback callBack){
		attribleEmpty(fuid);
