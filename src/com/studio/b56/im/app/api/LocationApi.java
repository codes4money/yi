...
public class LocationApi extends PanLvApi{
	...
	public void getDistanceList(String uid, String lat, String lng, String page, String pageSize, Map<String, String> param, ClientAjaxCallback callBack){
		getLocationList(uid, lat, lng, page, pageSize, param, callBack);
	}
	public void getDistanceList2(String uid, String lat, String lng, String page, String pageSize, Map<String, String> param, ClientAjaxCallback callBack){
		getLocationList2(uid, lat, lng, page, pageSize, param, callBack);
	}
	public void getDistanceList3(String uid, String lat, String lng, String page, String pageSize, Map<String, String> param, ClientAjaxCallback callBack){
		getLocationList3(uid, lat, lng, page, pageSize, param, callBack);
	}
	public void getScoreList(String uid, String lat, String lng, String page, String pageSize, Map<String, String> param, ClientAjaxCallback callBack){
		getLocationList(uid, lat, lng, page, pageSize, param, callBack);
	}
	 ...
	 * 修改时间:<br />
	 */
	public void getLocationList(String uid, String lat, String lng,String page, String pageSize, Map<String, String> param, ClientAjaxCallback callBack){
...
//		}
	...
	public void getLocationList2(String uid, String lat, String lng,String page, String pageSize, Map<String, String> param, ClientAjaxCallback callBack){
		AjaxParams params = null;
		if(param  == null){
			params = new AjaxParams();
		}else{
...
//		}
		...
		params.put("uid", uid);
		params.put("action", "serchbyphone");
		params.put("page", page);
		params.put("page_size", pageSize);
	...
	public void getLocationList3(String uid, String lat, String lng,String page, String pageSize, Map<String, String> param, ClientAjaxCallback callBack){
		AjaxParams params = null;
		if(param  == null){
			params = new AjaxParams();
		}else{
	...
	public void getLocationWhere(String uid, String sex, String occasions
			...
			String height, String weight, String agent, ClientAjaxCallback callBack){
	...
	public void getLocationList(String uid, String lat, String lng, String radius,
			String sradius, String page, String page_size, String sort, ClientAjaxCallback callBack){
	 ...
	 * 修改时间:<br />
	 */
	public void locationUplod(String uid, String lat, String lng, ClientAjaxCallback callBack){
	...
	class LocationUplodCallBack extends ClientAjaxCallback{
