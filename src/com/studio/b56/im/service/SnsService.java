...
import com.studio.b56.im.service.receiver.ConnectivityReceiver;
import com.studio.b56.im.service.receiver.NotificationReceiver;
import com.studio.b56.im.service.receiver.PhoneStateChangeListener;
...
public class SnsService extends Service{
	 ...
	 * */
	public static final String ACTION_SERVICE_STOP = "com.sns.yixun.service.ACTION_SERVICE_STOP";
	/**
	 ...
	 * */
	public static final String ACTION_REQUEST = "com.sns.yixun.service.ACTION_REQUEST";
	/**
	 ...
	 * */
	public static final String ACTION_RESULT = "com.sns.yixun.service.ACTION_RESULT";
	 ...
	 */
	public static final String ACTION_CONNECT_CHANGE = "com.sns.yixun.service.ACTION_CONNECT_CHANGE";
	...
	private static final String SERVICE_NAME = "cn.sns.yixun.SNSSERVICE";
	...
	public void onCreate() {
		...
		try {
			xmppManager = new XmppManager(this, userInfoVo.getUid(), userInfoVo.getPassword(),shangwupanlvApplication);
		} catch (Exception e) {
