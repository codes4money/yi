...
public class SNSRosterLisenerImpl implements RosterListener{
	 ...
	 */
	public static final String ACTION_AVAILABLE = "com.sns.roster.yixun.ACTION_AVAILABLE";
	/**
	 * 好友下线 <br/> {@link SNSRosterLisenerImpl#EXTRAS_ROSTER}
	 */
	public static final String ACTION_UNAVAILABLE = "com.sns.roster.yixun.ACTION_UNAVAILABLE";
	/**
	 * 被好友删除 <br/> {@link SNSRosterLisenerImpl#EXTRAS_ROSTER}
	 */
	public static final String ACTION_DELETEED = "com.sns.roster.yixun.ACTION_DELETEED";
	/**
	 * 添加好友 <br/> {@link SNSRosterLisenerImpl#EXTRAS_ROSTER}
	 */
	public static final String ACTION_ADDED = "com.sns.roster.yixun.ACTION_ADDED";
	/**
	 * 好友动态更新 <br/> {@link SNSRosterLisenerImpl#EXTRAS_ROSTER}
	 */
	public static final String ACTION_UPDATE = "com.sns.roster.yixun.ACTION_UPDATE";
	/**
	 * 附加信息: 用户 ChatID
	 */
